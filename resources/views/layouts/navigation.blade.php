        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @auth
                        {{-- Dashboard Link (Dynamically points to User or Admin Dashboard) --}}
                        ...
                        {{-- Guided Learning Link (Visible to all authenticated users) --}}
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @auth
                ...
                {{-- Guided Learning Link (Visible to all authenticated users) --}}
                <x-responsive-nav-link :href="route('learn.start')" :active="request()->routeIs('learn.start')">
                    {{ __('Start Learning') }}
                </x-responsive-nav-link>
            @endauth
        </div>
